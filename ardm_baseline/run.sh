...
python -m ardm_baseline.experiments.images.main --work_unit_dir=results/images --config ardm_baseline/experiments/images/config.py \
...
python -m ardm_baseline.experiments.language.main --work_unit_dir=results/language --config ardm_baseline/experiments/language/configs/default.py \
  --config.num_train_steps 1 --config.num_layers 0

# Runs the main audio experiment.
python -m ardm_baseline.experiments.audio.main --work_unit_dir=results/audio --config ardm_baseline/experiments/audio/configs/sc09.py \
