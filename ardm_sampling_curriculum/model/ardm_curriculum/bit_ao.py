...
from ardm_sampling_curriculum.model.ardm_curriculum import ardm_utils
from ardm_sampling_curriculum.model.ardm_curriculum import transitions

from ardm_sampling_curriculum.utils import distribution_utils
from ardm_sampling_curriculum.utils import dynamic_programming
...
class BitUpscaleAutoregressiveDiffusion(struct.PyTreeNode):
  ...
  def sample_q_t(self, rng, batch_size):
    ...
    """
    if self.config.elbo_mode in ('uniform', 'adaptive_t', 'curriculum_t'):
