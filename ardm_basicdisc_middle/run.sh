...
python -m ardm_basicdisc_middle.experiments.images.main --work_unit_dir=results/images --config ardm_basicdisc_middle/experiments/images/config.py \
...
python -m ardm_basicdisc_middle.experiments.language.main --work_unit_dir=results/language --config ardm_basicdisc_middle/experiments/language/configs/default.py \
  --config.num_train_steps 1 --config.num_layers 0

# Runs the main audio experiment.
python -m ardm_basicdisc_middle.experiments.audio.main --work_unit_dir=results/audio --config ardm_basicdisc_middle/experiments/audio/configs/sc09.py \
