...
from ardm_advanceddisc_reasoning_middle.model.autoregressive_diffusion import ardm_utils
from ardm_advanceddisc_reasoning_middle.model.autoregressive_diffusion import transitions

from ardm_advanceddisc_reasoning_middle.utils import distribution_utils
from ardm_advanceddisc_reasoning_middle.utils import dynamic_programming
from ardm_advanceddisc_reasoning_middle.utils import util_fns
...
class BitUpscaleAutoregressiveDiffusion(struct.PyTreeNode):
  ...
  def elbo_with_features(self, rng, params, x, train, context=None,
    ...
    rng_perm, rng_t, rng_drop, rng_drop_real = jax.random.split(rng, 4)
