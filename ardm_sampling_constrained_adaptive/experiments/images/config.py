...
def get_config():
  ...
  config.elbo_mode = 'constrained_adaptive_t'  # choices: uniform, antithetic, stratified_t, adaptive_t, constrained_adaptive_t, curriculum_t
  ...
  # constrained_adaptive_t: adapts inside observed-fraction buckets while
  # preserving the original uniform observed-fraction/mask-difficulty marginal.
  ...
  # Constrained adaptive sampler.  This is the main experiment in this package.
  # It uses the same model/data/epochs as baseline.  The policy is adaptive
  # within mask/observed-fraction buckets, but the total probability mass of
  # each bucket is fixed to the original uniform distribution, preventing the
  # sampler from simply drifting toward lower-observed/harder masks.
