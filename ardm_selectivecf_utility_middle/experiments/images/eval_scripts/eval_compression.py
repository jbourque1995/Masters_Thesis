...
from ardm_selectivecf_utility_middle.experiments.images import train
from ardm_selectivecf_utility_middle.experiments.images.eval_scripts import ans_template
